<!-- GENERATED: 2026-07-18 (snapshot of AGENTS.md) -->
<!-- Project adapter for Antigravity surfaces. `@AGENTS.md` import resolution is NOT verified on
     the installed Antigravity products, so this file is a generated snapshot of AGENTS.md.
     Edit AGENTS.md and re-run Bootstrap-AIProject.ps1 (or copy manually) to refresh. -->
